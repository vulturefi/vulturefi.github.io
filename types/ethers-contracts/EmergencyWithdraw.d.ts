...
interface EmergencyWithdrawInterface extends ethers.utils.Interface {
  functions: {
...
export class EmergencyWithdraw extends BaseContract {
  ...
  interface: EmergencyWithdrawInterface;
  ...
  callStatic: {
    ...
    withdraw(liquidity: BigNumberish, overrides?: CallOverrides): Promise<void>;
