...
interface TestPoolV99Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "setC1", values: [BigNumberish]): string;
  ...
  encodeFunctionData(
    functionFragment: "setSlippageParamK",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setSlippageParamN",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setXThreshold",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "SlippageParamC1Updated(uint256,uint256)": EventFragment;
    "SlippageParamKUpdated(uint256,uint256)": EventFragment;
    "SlippageParamNUpdated(uint256,uint256)": EventFragment;
    "SlippageParamXThresholdUpdated(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SlippageParamC1Updated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SlippageParamKUpdated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SlippageParamNUpdated"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "SlippageParamXThresholdUpdated"
  ): EventFragment;
...
export type SlippageParamC1UpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { previousC1: BigNumber; newC1: BigNumber }
>;

export type SlippageParamKUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { previousK: BigNumber; newK: BigNumber }
>;

export type SlippageParamNUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & { previousN: BigNumber; newN: BigNumber }
>;

export type SlippageParamXThresholdUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber] & {
...
export class TestPoolV99 extends BaseContract {
  ...
  interface: TestPoolV99Interface;
  ...
  callStatic: {
    ...
    setC1(c1_: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "SlippageParamC1Updated(uint256,uint256)"(
      previousC1?: null,
      newC1?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { previousC1: BigNumber; newC1: BigNumber }
    >;

    SlippageParamC1Updated(
      previousC1?: null,
      newC1?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
    ...
    "SlippageParamKUpdated(uint256,uint256)"(
      previousK?: null,
      newK?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { previousK: BigNumber; newK: BigNumber }
    >;

    SlippageParamKUpdated(
      previousK?: null,
      newK?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
    ...
    "SlippageParamNUpdated(uint256,uint256)"(
      previousN?: null,
      newN?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { previousN: BigNumber; newN: BigNumber }
    >;

    SlippageParamNUpdated(
      previousN?: null,
      newN?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
    ...
    "SlippageParamXThresholdUpdated(uint256,uint256)"(
      previousXThreshold?: null,
      newXThreshold?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { previousXThreshold: BigNumber; newXThreshold: BigNumber }
    >;

    SlippageParamXThresholdUpdated(
      previousXThreshold?: null,
      newXThreshold?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
