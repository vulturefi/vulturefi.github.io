...
interface OwnableTestERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class OwnableTestERC20 extends BaseContract {
  ...
  interface: OwnableTestERC20Interface;
  ...
  functions: {
    ...
    d(overrides?: CallOverrides): Promise<[number]>;
