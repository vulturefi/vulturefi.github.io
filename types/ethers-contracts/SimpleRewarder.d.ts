...
interface SimpleRewarderInterface extends ethers.utils.Interface {
  functions: {
...
export type OnRewardEvent = TypedEvent<
...
export class SimpleRewarder extends BaseContract {
  ...
  filters: {
    ...
    "RewardRateUpdated(uint256,uint256)"(
      oldRate?: null,
      newRate?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
